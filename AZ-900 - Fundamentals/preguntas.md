...
<b>2. ¿A qué se refiere el término disponibilidad en una aplicación?</b>
   - El tiempo total en el que un sistema se encuentra funcional.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Al acuerdo de nivel de servicio del recurso asociado.
   - A si la aplicación soporta una zona de disponibilidad.
...
<b>5. ¿Cuál de las siguientes situaciones produciría los mayores beneficios de la reubicación de un almacén de datos local a Azure?</b>
   - Demanda de almacenamiento constante e invariable.
   - Demanda de almacenamiento impredecible que aumenta y disminuye varias veces durante el año.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
...
<b>6. Un Grupo de recursos puede tener el rol de propietario asignado a varios usuarios.</b>
   ...
   <b>GRUPO DE RECURSOS = UN ÚNICO USUARIO CON ROL DE PROPIETARIO.</b>
...
<b>8. Desde Azure Service Health, un administrador puede crear una regla para recibir una alerta si falla un servicio de Azure.</b>
   - Verdadero.
   - Falso.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>

<b>9. Azure Cost manager se usa para:</b>
   ...
   <b>RECORDAR QUE CON AZURE COST MANAGER NO PODEMOS REALIZAR ESTIMACIONES DE CAMBIO.</b>
...
<b>16. Tiene una suscripción de Azure denominada Az900-Subscription. Inicie sesión en Azure Portal y cree un grupo de recursos denominado RG-AZ-900. Tiene la intención de utilizar el siguiente comando que crea una maquina virtual llamada VirtualMachine01. az vm create --resource-group RG-AZ-900 -nombre VirtualMachine01 --image UbuntuLTS --generate-ssh-keys. Debe crear VirtualMachine01 en Az900-Subscription mediante el comando. Solución: Desde Azure Portal, inicie Azure Cloud Shell y seleccione Bash. Ejecute el comando en Cloud Shell. ¿Esto cumple la meta?</b>
   - Sí.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - No.
...
<b>17. Suponga que tiene una aplicación existente que se ejecuta localmente en su propio servidor. Necesita capacidad adicional, pero prefiere cambiar a Azure en lugar de comprar Hardware. ¿Qué opción de proceso le brindaría la ruta más rápida para hacer que su aplicación se ejecute en Azure?</b>
   ...
   <b>RECORDAR LA RESPUESTA: QUE LA PALABRA RÁPIDA NO TE CONFUNDA A LA HORA DE SELECCIONAR LA OPCIÓN CORRECTA.</b>

<b>18. Un recurso de Azure hereda locks de su grupo de recursos.</b>
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.

<b>19. Seleccione la solución que no ahorra costes:</b>
   ...
   <b>OPCIONES B y C CLARAMENTE AHORRAN COSTES. ENTRE OPCIÓN A y D OPCIÓN CORRECTA ES D. INVESTIGAR A QUÉ SE REFIERE UNA INSTANCIA RESERVADA.</b>
...
<b>21. Como administrador, debe recuperar la dirección IP de una VM determinada mediante Bash ¿Cuál de las siguientes herramientas debe usar?</b>
   ...
   <b>RECORDAR LA RESPUESTA. NO CONFUNDIR CON LA OPCIÓN D. REVISAR CUÁL ERA LA DIFERENCIA ENTRE AMBAS.</b>
...
<b>22. Quiere desplegar una aplicación web en Azure. Esta web será accedida por usuarios repartidos por todo el mundo y servirá grandes ficheros de video. ¿Qué servicio de Azure se recomienda para proporcionar la mejor experiencia de usuario?</b>
   ...
   <b>RECORDAR RESPUESTA. TIENE SENTIDO VIENDO LAS POSIBLES OPCIONES SI TRADUCIMOS.</b>

<b>23. Se pueden aplicar Tags a cualquier tipo de recursos en Azure.</b>
   - Verdadero.
   - Falso.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b><br><br>
   <b>RECORDAR RESPUESTA. NO CAER EN LA TRAMPA DE LA GENERALIZACIÓN.</b>
...
<b>24. Conteste Sí o No a las siguientes afirmaciones:</b>
   ...
   - Windows Virtual Desktop es compatible con la virtualización de aplicaciones y escritorios.   &emsp; &emsp; &emsp; &emsp; <b>SI</b>
   - Un host de sesión de Windows Virtual Desktop solo puede ejecutar W10.   &emsp; &emsp; &emsp; &emsp; <b>NO</b>
  
<b>25. Los tres tipos de clientes principales para contratar productos y servicios en Azure son:</b>
...
<b>26. ¿Qué enfoque debería adoptar la empresa para agregar el servicio en versión preliminar de realidad aumentada (AR) a su arquitectura?</b>
   ...
   - El equipo de desarrollo puede crear una versión prototipo de la aplicación que incluya el servicio AR, y someterla a prueba con algunos empleados de las tiendas minoristas.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
...
<b>27. Cada cuenta de usuario en Azure Active Directory (Azure AD) puede ser asignada solo a una licencia.</b>
   - Falso.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Verdadero.

<b>28. Puede asociar un grupo de seguridad de red (NSG) a una interfaz de red.</b>
   - Falso.
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
  
<b>29. ¿Cuál de los siguientes es un ejemplo de servicio de procesos de Azure?</b>
   - Máquina virtual de Azure.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Azure Table Storage.
   - Balanceador de carga de Azure.
   - Azure Cache for Redis.<br><br>
   <b>NO COMPLICARSE EN LA RESPUESTA.</b>

<b>30. ¿Qué servicios suelen tener menor costo?</b>
   - IaaS.
   - PaaS.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b><br><br>
   <b>RAZONANDO EN UNA PaaS AZURE TIENE MAYOR RESPONSABILIDAD, PERO NO HAY ENTIDAD FÍSICA QUE DEBA VENDERTE. SIGUIENDO ESE RAZONAMIENTO EL SaaS TENDRÍA QUE SER EL SERVICIO MÁS BARATO.</b>
...
<b>32. Puede asociar un grupo de resuridad de red (NSG) a una subred de red virtual.</b>
   - Falso.
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>

<b>33. ¿Qué servicio proporciona tráfico de red en varias suscripciones de azure y redes virtuales?</b>
...
<b>35. Imagina que trabajas en una aplicación para compartir fotos que se ejecuta en millones de dispositivos moviles. La demanda es impredecible porque observa un aumento en el uso cada vez que ocure un evento significativo a nivel local o nacional. ¿Qué recurso de proceso en Azure es el mejor que se adapta a esta carga de trabajo?</b>
   ...
   <b>RECUERDA ESTA RESPUESTA. SERVERLESS COMPUTING TAMBIÉN PUEDE ESCALAR.</b>
...
<b>37. Un grupo de recursos contiene múltiples subscripciones de Azure.</b>
   - Verdadero.
   - Falso.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
...
<b>38. ¿Cuál de las siguientes opciones sería buena para poner un bloqueo de recursos?</b>
   ...
   <b>ANALIZANDO LAS POSIBLES RESPUESTAS LAS OPCIONES B y C NO TIENEN DEMASIADO SENTIDO.</b>
...
<b>40. Puedes crear diferentes directivas (group policies) en Azure AD.</b>
   - Verdadero.   &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.
...
<b>43. Una empresa implementa varios recursos de Azure en su suscripción. Quieren estar informados si el costo de cualquier recurso supera un cierto umbral. ¿Cuál de las siguientes opciones puede ayudarlo a lograrlo?</b>
...
<b>45. Solo puede haber un administrador de cuenta asignado a la suscripción de Azure.</b>
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.<br><br>
   <b>RECORDAR ESTA RESPUESTA. UN ÚNICO PROPIETARIO. UN ÚNICO ADMINISTRADOR.</b>
...
<b>46. Tiene una aplicación Web de Azure. Debe administrar la configuración de la aplicación Web desde un Iphone. ¿Cuáles son las dos herramientas de administración de Azure que puede usar?</b>
   ...
   - Windows Powershell.
   - Azure CLI.<br><br>
   <b>RECORDAR RESPUESTA. LA OPCIÓN A NO LA HABÍAMOS TENIDO EN CUENTA.</b>
...
<b>49. Su empresa tiene un contrato de Software Assurance que incluye licencias de Microsoft SQL Server. Tiene previsto implementar SQL server en máquinas virtuales de Azure. ¿Qué debe hacer para minimizar los costos de licencia para la implementación?</b>
   ...
   <b>RECORDAR RESPUESTA. LA OPCIÓN B TAMBIÉN PARECÍA QUE PODÍA SER SOLUCIÓN.</b>
...
<b>51. Una empresa puede ampliar la capacidad de su red interna utilizando la nube pública.</b>
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.

<b>52. Una Azure Web app que consulta un servidor local Microsoft SQL es un ejemplo de:</b>
   - Nube híbrida.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Nube privada.
   - Nube pública.
   - Nube multi-vendor.<br><br>
   <b>RECORDAR RESPUESTA E INTENTAR RAZONAR EL POR QUÉ.</b>
...
<b>53. Una solución de plataforma como servicio (PaaS) que aloja aplicaciones Web en Azure puede recibir memoria adicional cambiando el nivel de precios.</b>
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.<br><br>
   <b>"Una solución PaaS no proporciona acceso al sistema operativo. Mientras usa una aplicación Azure PaaS que hospeda sus aplicaciones web, puede cambiar el nivel de precios para agregar memoria adicional".</b>
...
<b>54. ¿Cuál de los siguientes se utilizan para determinar los costos de Azure para cada periodo de facturación?</b>
   ...
   <b>RECORDAR RESPUESTA. LA OPCIÓN D NO ES CORRECTA.</b>

<b>55. ¿Puedes asignar un Azure blueprint a un grupo de recursos (resource group)?</b>
   - Verdadero.
   - Falso.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b><br><br>
   <b>RECORDAR RESPUESTA. INVESTIGAR QUE ES UN AZURE BLUEPRINT.</b>
...
<b>57. ¿Qué tarea puede realizar el Azure Advisor?</b>
   ...
   <b>TIRÁNDOME TRIPLE ACIERTO GRACIAS A COMPARAR LA LÓGICA DEL RESTO DE OPCIONES POSIBLES.</b>
...
<b>59. Su entorno de Azure contiene varias máquinas virtuales de Azure. Debe asegurarse de que se pueda acceder a una máquina virtual llamada VM1 desde internet a través de HTTP. ¿Cuáles son dos posibles soluciones?</b>
...
<b>60. Para usar las credenciales de Azure Active Directory (Azure AD) para iniciar sesión que ejecuta W10, el equipo debe esta unido a Azure AD.</b>
   - Verdadero.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Falso.
  
<b>61. ¿Qué servicio de Azure proporciona información de estado actualizada sobre el estado de los servicios de Azure?</b>
...
<b>67. Su empresa tiene varios ordenadores locales con W10. Quieren usar un disco en red para estas máquinas. ¿Qué servicio de Azure recomendaría?</b>
   - Azure Blob Storage.
   - Azure File Storage.  &emsp; &emsp; &emsp; &emsp; <b>CORRECTO</b>
   - Azure Sql Database.
   - Azure Synapse Analytics.<br><br>
   <b>RECORDAR RESPUESTA. INVESTIGAR POR QUÉ LA OPCIÓN A NO ES VÁLIDA.</b>
...
<b>70. Su empresa quiere usar Azure ExpressRoute para conectar su red local a la nube de Microsoft. ¿Cuál de las siguientes opciones no es un modelo de ExpressRoute que su empresa puede usar?</b>
